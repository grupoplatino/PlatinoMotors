        ...
        <div className='bg-other bg-otherLight-50'>
            <div className="container mx-auto">
                <div className="flex justify-center md:justify-between px-2 md:px-0 rounded-sm">
                    <div className='grid grid-cols-1 items-center md:grid-cols-2 gap-2 bg-white md:gap-20 my-5 mx-2 md:mx-0 rounded-xl drop-shadow-md'>
                        <div className='mx-2 md:mx-5'>
                            <div className='grid grid-cols-1 justify-center md:justify-start'>
