    ...
    return (
        <>
            <div className="services_and_parts">
                <div className="container mx-auto md:pt-24 md:pb-32">
                    <div className="flex justify-center md:justify-start">
                        <div>
                            <p className="text-white text-5xl font-pop font-bold mb-2 mt-14 md:mb-3">Partes y Servicios</p>
                            <p className="text-white text-base font-pop font-semibold">Te apoyamos a Construir tu Camino</p>
                        </div>
                    </div>
                </div>
            </div>
