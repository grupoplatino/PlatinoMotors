            ...
            <section className="bg-hero h-100 sm:h-120 w-full bg-cover bg-center py hidden lg:block">
                <div className="flex justify-center sm:justify-start">
                    <div className="px-2 sm:px-10 py-36 mx-20">
                        <p className="text-white text-center sm:text-left text-5xl font-bold font-pop mb-3">{t("home.hero.left_title")} </p>
                        <p className="text-white text-center sm:text-left text-5xl font-bold font-pop mb-5">{t("home.hero.right_title")}</p>
                        <p className="text-white text-center sm:text-left font-pop text-lg font-semibold mb-2">{t("home.hero.description")}</p>
                        ...
                        <div className="flex justify-center sm:justify-start">
                            ...
                            focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 border-none font-medium text-sm text-center mr-2 mb-2 font-pop">{t("home.hero.button")}</Link>
                        </div>
                    </div>
                </div>
            </section>
            <section className="lg:hidden container mx-auto">
                <div className="grid grid-cols-1 md:items-center sm:text-center md:grid-cols-2">
                    <div className="px-6 py-10">
                        <p className="text-3xl font-bold font-pop mb-3">{t("home.hero.title")}</p>
                        <p className="font-pop text-lg font-semibold mb-2">{t("home.hero.description")}</p>
                        ...
                        <Link to="/shop/category" className="text-background bg-gradient-to-r rounded-3xl px-12 py-2 from-startGradiant to-endGradiant hover:bg-gradient-to-br focus:ring-4 
                            focus:outline-none border-none font-medium text-md text-center mr-2 mb-2 font-pop">{t("home.hero.button")}</Link>
                        </div>
                    </div>
