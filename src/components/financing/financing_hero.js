    ...
    <div className="financingHero">
        <div className="container mx-auto">
            <div className="flex justify-center md:justify-start mx-4 py-10 md:py-14">
                <div>
                    <p className="text-white  font-pop text-center md:text-left font-bold text-xl md:text-2xl mb-3">Financiamiento para Maquinaria</p>
                    ...
                    <img className="h-10 md:h-14" src={PlatinoCapitalWhite}/>
                    </div>
                </div>
