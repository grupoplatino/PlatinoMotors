                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-20 my-5">
                    <div>
                        <div className="grid grid-cols-1 justify-center mb-5 md:mt-16 mt-8 md:justify-start">
                            ...
                            <p className="font-pop md:mr-24 mb-5">¿Tienes consultas sobre nuestra maquinaria? ¿Necesitas un mantenimiento preventivo o correctivo de tus equipos? Permitenos despejar tus consultas.</p>
